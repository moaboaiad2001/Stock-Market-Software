class Investment {
  ...
  getIncrease(period: "Live" | "1D" | "1W" | "1M" | "3M" | "1Y" | "YTD"): number {
    switch (period) {
      case "Live":
        return 0; // No increase for "Live" (current value), or adjust if intra-day data exists
      case "1D":
  ...
  getPercentIncrease(period: "Live" | "1D" | "1W" | "1M" | "3M" | "1Y" | "YTD"): number {
    let baseAmount;
    switch (period) {
      case "Live":
        return 0; // No percentage change for "Live"
      case "1D":
